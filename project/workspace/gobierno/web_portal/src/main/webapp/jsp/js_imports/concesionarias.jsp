...
<script src="/web_portal/util/Javascript.do/load=own_libraries/concesionarias/concesionarias_module"></script>
<script src="/web_portal/util/Javascript.do/load=own_libraries/concesionarias/concesionarias_loader"></script>