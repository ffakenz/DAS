...
<table id="table_admin_result" class="stripe table_report display nowrap row-border hover order-colum" style="width:100%">
<thead>
<tr>
...
<fmt:message key="table_consumo_job_consumo_result_title" var="title" bundle="${etq}" />
