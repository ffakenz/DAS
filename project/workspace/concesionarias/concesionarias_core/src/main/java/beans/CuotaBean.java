...
public class CuotaBean implements Serializable {
    ...
    public static CuotaBean fromNotificationUpdate(final NotificationUpdate notificationUpdate) {
        ...
        bean.setCuotaNroCuota(notificationUpdate.getCoutaNroCuota());
        bean.setCuotaFechaAlta(notificationUpdate.getCuotaFechaAlta());
        bean.setCuotaFechaVencimiento(notificationUpdate.getCoutaFechaVencimiento());
        bean.setCuotaMonto(notificationUpdate.getCoutaMonto());
        bean.setCuotaFechaPago(notificationUpdate.getCoutaFechaPago());
        return bean;
    }
